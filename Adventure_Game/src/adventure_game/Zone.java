...
public class Zone {
     ...
     * @param est
     */
    public void ajoutSalle(String id, String ennemi, Objet item, String sud, String est, String nord, String ouest) {
        Salle s = new Salle(Integer.parseInt(id), Zombie.chaineVersEnnemi(ennemi), item);
